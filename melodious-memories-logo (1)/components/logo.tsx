...
import { type LogoProps, LogoVariations } from "./logo-variations"
      ...
      <div className={cn("relative inline-block", className)} style={{ width: size, height: size }}>
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <text x="100" y="120" className={playfair.className} textAnchor="middle" fill="white" fontSize={24 * scale}>
            MM
          </text>
          <defs>
      ...
      <div className={cn("relative inline-block", className)} style={{ width: size, height: size }}>
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <path d="M50 100C50 72.3858 72.3858 50 100 50" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
          <text
            x="100"
            y="140"
  ...
  return (
    <div className={cn("relative inline-block", className)} style={{ width: size, height: size }}>
      <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        {/* Musical staff lines */}
        <path d="M50 100C50 72.3858 72.3858 50 100 50" stroke="white" strokeWidth="4" strokeLinecap="round" />
        ...
        <text x="100" y="170" className={playfair.className} textAnchor="middle" fill="white" fontSize={16 * scale}>
          MEMORIES
        </text>
      </svg>
    </div>
